/*! UIkit 3.23.12 | https://www.getuikit.com | (c) 2014 - 2025 YOOtheme | MIT License */ (function (
  Se,
  Ie
) {
  ...
  const qt = typeof window < "u",
    ...
    ce = qt && "ontouchstart" in window,
    ue = qt && window.PointerEvent,
    ut = ue ? "pointerdown" : ce ? "touchstart" : "mousedown",
    Me = ue ? "pointermove" : ce ? "touchmove" : "mousemove",
    _t = ue ? "pointerup" : ce ? "touchend" : "mouseup",
    At = ue ? "pointerenter" : ce ? "" : "mouseenter",
    Ut = ue ? "pointerleave" : ce ? "" : "mouseleave",
  ...
  function es(t, e) {
    return E(
      E(t).map((i) => (i.hasChildNodes() ? Le(re(i.childNodes), e) : W(i, e)))
    );
  }
  function We(t) {
    E(t)
  ...
  const Gt = { width: ["left", "right"], height: ["top", "bottom"] };
  function g(t) {
    const e = ae(t)
  ...
  function ge(t, e, i = "border-box") {
    return h(t, "boxSizing") === i
      ? jt(Gt[e], (s) => S(h(t, `padding-${s}`)) + S(h(t, `border-${s}-width`)))
      : 0;
  }
  function bi(t) {
    for (const e in Gt)
      for (const i in Gt[e]) if (Gt[e][i] === t) return Gt[e][1 - i];
    return t;
  }
    ...
    function s(r, a, l, c) {
      return new Promise((u) => {
        ...
        (function Tt() {
          ...
          i[0] === r &&
            d + a < c &&
            (bt = T(l).top + (b ? 0 : r.scrollTop) - y - g(ds(l)).height),
            h(r, "scrollBehavior") !== "auto" && h(r, "scrollBehavior", "auto"),
            (r.scrollTop = d + (a + bt) * zt),
            h(r, "scrollBehavior", ""),
            zt === 1 && (P === bt || !it--)
              ? u()
              : ((P = bt), requestAnimationFrame(Tt));
        })();
      });
    }
    function n(r) {
  ...
  function Kr(t) {
    return J(t)
      ? t
      : H(t)
      ? t.split(Jr).map((e) => (mt(e) ? $t(e) : ji(e.trim())))
      : [t];
  }
  function Zr(t) {
    (t._data = {}),
  ...
  async function ma(
    ...
    s = (n * ne + s) * (e ? 1 - or : or);
    const rr = { [b]: e ? ne : 0 };
    f && (h(t, y, ne - it + Us), (rr[y] = e ? Us : ne + Us)),
      !f ^ (l === "reveal") &&
        (h(Li, y, -ne + it), M.start(Li, { [y]: e ? 0 : -ne }, s, o));
    try {
    ...
    events: [
      {
        ...
        handler(t) {
          const { current: e, defaultPrevented: i } = t,
            { hash: s } = e;
          !i && s && Vt(e) && !this.$el.contains(x(s))
            ? this.hide()
            : C(e, this.selClose) && (Et(t), this.hide());
        },
      },
      {
        name: "toggle",
    ...
    return {
      ...
      show(d, f = 0, p) {
        ...
        return (
          ...
          this.translate(f),
          Zt(e, "itemin", { percent: f, duration: d, timing: b, dir: i }),
          Zt(t, "itemout", { percent: 1 - f, duration: d, timing: b, dir: i }),
      ...
      translate(d) {
        ...
        h(e, f[1]),
          h(t, f[0]),
          Zt(e, "itemtranslatein", { percent: d, dir: i }),
          Zt(t, "itemtranslateout", { percent: 1 - d, dir: i });
      },
      percent() {
        return o(t || e, e, i);
      },
  ...
  var Ia = {
    ...
    methods: {
      ...
      move(t) {
        ...
        if (
          (Yt(document, As, this.move, Ti),
          Yt(document, Gn, this.end, Yn),
          this.dragging)
        )
          if (
  ...
  function Ea(t) {
    return (
      h(t, "userSelect") !== "none" &&
      re(t.childNodes).some((e) => e.nodeType === 3 && e.textContent.trim())
    );
  }
  function Ta(t) {
    t._watches = [];
  ...
  function _a(t) {
    t._hasComputed &&
      (Qr(t, { read: () => Ca(t, Qn(t)), events: ["resize", "computed"] }),
      ...
      navItems(t) {
        for (const e of t) {
          ...
          if (mt(i)) {
            const r = $t(i),
              a = this.slides[r];
            a && (a.id || (a.id = te(this, a)), (o = a.id)),
              (n = this.t("slideX", S(i) + 1)),
              (s.role = "tab");
          } else
            this.list &&
              (this.list.id || (this.list.id = te(this, this.list)),
              (o = this.list.id)),
              (n = this.t(i));
  ...
  var el = {
    ...
    events: {
      ...
      handler(t) {
        t.defaultPrevented ||
          (t.preventDefault(), C(t.current, tl) || this.show(t.current));
      },
    },
    methods: {
      show(t) {
    ...
    $l = {
      ...
      methods: {
        ...
        move: Cl(function (t) {
          ...
          if (
            (Yt(document, Me, this.move),
            Yt(document, _t, this.end),
            !this.drag)
          )
            return;
          kl();
  ...
  function yl(t) {
    ...
    Do = setInterval(() => {
      ...
      (e = Date.now()),
        Xt(document.elementFromPoint(i, t.y))
          .reverse()
          .some((o) => {
        ...
        (this.tooltip = W(
          ...
          w(this.tooltip, "toggled", (i, s) => {
            ...
            const a = [
              ...
              w([document, ...Jt(this.$el)], "scroll", n, { passive: !0 }),
            ];
  ...
  function Xl(t) {
    const e = () => t.$emit(),
      i = [os(e), qe(Jt(t.$el).concat(t.target), e)];
    return () => i.map((s) => s.disconnect());
  }
  function qo(t, e = () => t.$emit()) {
    return w([document, ...Jt(t.$el)], "scroll", e, { passive: !0 });
  }
  function Jl(t) {
    return w(document, "keydown", (e) => {
        ...
        handler(t) {
          ...
          if (s === B.DOWN)
            if ((n == null ? void 0 : n.targetEl) === i)
              t.preventDefault(), (e = x(de, n.$el)) == null || e.focus();
            else {
          ...
          const e = this.getDropdown(t),
            i = () => {
              ...
              T(this.dropbar, {
                ...
                this.transitionTo(
                  s - T(this.dropbar).top + S(h(t, "marginBottom")),
                  t
                );
            };
        ...
        read() {
          ...
          if (((t = `calc(${r ? "100vh" : `${o}px`}`), this.expand)) {
            ...
            this.offsetBottom === !0
              ...
              : this.offsetBottom && oe(this.offsetBottom, "px")
  ...
  const Ah = /<symbol([^]*?id=(['"])(.+?)\2[^]*?<\/)symbol>/g,
    ...
    Fh = { extends: se, i18n: { label: "Open" } },
    Hh = { extends: se, i18n: { label: "Back to top" } },
    Lh = { extends: se, i18n: { label: "Next page" }, data: { role: null } },
    Wh = {
      extends: se,
        ...
        return e(
          ({ i18n: n }) =>
            `<div class="uk-modal-body">${
              H(i) ? i : vt(i)
            }</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-primary uk-modal-close" type="button" autofocus>${
              n.ok
            }</button> </div>`,
          s
        );
  ...
  var hc = {
    ...
    cc = {
      ...
      computed: { links: ({ target: t }, e) => D(t, e).filter(Vt) },
      watch: {
        links(t) {
      ...
      update: [
        {
          read() {
            const t = this.links.filter(ui),
              e = t.map(ui),
              { length: i } = e;
            if (!i || !q(this.$el)) return !1;
            const s = Bt(e, !0),
              { scrollTop: n, scrollHeight: o } = s,
              r = at(s),
              a = o - r.height;
            let l = !1;
            if (n >= a) l = i - 1;
            else {
              const c = this.offset + g(ds()).height + r.height * 0.1;
              for (
                let u = 0;
                u < e.length && !(T(e[u]).top - r.top - c > 0);
                u++
              )
                l = +u;
            }
            return { active: l, links: t };
          },
          write({ active: t, links: e }) {
            const i = e.map((n) => n.closest(this.closest || "*")),
              s = t !== !1 && !$(i[t], this.cls);
          ...
          read({ height: t, width: e, margin: i, sticky: s }, n) {
            ...
            return (
              (s =
                !this.showOnUp &&
                it + d === y &&
                Tt === Math.min(r, Ls(!0, this.$el, 0, !0) - P - d + b) &&
      ...
      events: [
        {
          ...
          handler(t) {
            (this._preventClick = null),
              !(!pt(t) || le(this._showState) || this.$el.disabled) &&
                (m(this.$el, "focus"),
                z(
                  document,
                  ut,
        ...
        },
        {
          ...
          handler(t) {
            ...
            (e && le(this._showState) && i !== this._showState) ||
        ...
        },
        {
          ...
          handler(t) {
            ...
            const e = t.target.closest("a[href]"),
              i = Vt(e) && (!e.hash || C(this.target, e.hash));
  ...
  return (
    he(wc, (t, e) => ht.component(e, t)),
    Fl(ht),
    he(zl, (t, e) => ht.component(e, t)),
    ht
  );
});
